...
const MENU_ITEMS = [
  ...
  { href: '/tenant/billing', label: 'My Bills', icon: Receipt },
  { href: '/tenant/profile', label: 'My Profile', icon: User },
];

export default function TenantSidebar({ sidebarOpen, setSidebarOpen, user }: TenantSidebarProps) {
    ...
    >
      ...
      <div className="h-16 flex items-center px-6 border-b border-slate-800">
        ...
        <div>
          ...
          <p className="text-[10px] text-slate-400 uppercase tracking-widest font-semibold">Tenant Portal</p>
        </div>
      </div>
